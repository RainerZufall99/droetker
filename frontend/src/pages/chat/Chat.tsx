                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Jetzt starten</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Dieser Chatbot hilft dir, das richtige Rezept zu finden</h2>
                            </Stack>
                        ) : (
